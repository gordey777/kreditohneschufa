...
register_sidebar( array(
        'name' => __( 'Home [List]', '' ),
        'id' => 'home-list',
        'before_widget' => '<div class="list"><div class="container border">',
...
register_sidebar( array(
        'name' => __( 'Home [Text]', '' ),
        'id' => 'home-text',
        'before_widget' => '<div class="footer-text"><div class="container">',
        'after_widget' => '</div></div>',
        'before_title' => '',
        'after_title' => '',
    ) );
...
register_sidebar( array(
        'name' => __( 'Home [Slider]', '' ),
        'id' => 'home-slider',
        'before_widget' => '<div id="slider" class="owl-carousel owl-theme">',
        'after_widget' => '</div>',
        'before_title' => '',
        'after_title' => '',
    ) );
...
function catch_that_image() {
  ...
  if(empty($first_img)){ //Defines a default image
    $first_img = "/wp-content/themes/default/images/default.png";
  }
  return $first_img;
}
