...
if ( ! class_exists( 'Enki_Builder_Layout_Creative' ) ) {

	class Enki_Builder_Layout_Creative extends Enki_Builder_Layout_Pattern {
		...
		function __construct() {
			$this->layout_slug = 'home_creative';			
			$this->layout_name = esc_html__( 'Home Creative', 'enki' );
		...
		private function _init_rows() {
			return array(
				...
				'row-2'  => array( 'title' => esc_html__( 'Row 2', 'enki' ), 'grid' => array( 6, 6 ) ),
				...
				'row-7'  => array( 'title' => esc_html__( 'Row 7', 'enki' ), 'grid' => array( 7, 5 ) ),
				'row-8'  => array( 'title' => esc_html__( 'Row 8', 'enki' ), 'grid' => array( 12 ) ),				
				'row-9'  => array( 'title' => esc_html__( 'Row 9', 'enki' ), 'grid' => array( 3, 9 ) )				
			);
		}		
